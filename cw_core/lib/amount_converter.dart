...
class AmountConverter {
  static const _xcashKAmountLength = 6;
  static const _xcashKAmountDivider = 1000000;
  ...
  static final _xcashKAmountFormat = NumberFormat()
    ..maximumFractionDigits = _xcashKAmountLength
    ..minimumFractionDigits = 0;
  ...
  static String amountIntToString(CryptoCurrency cryptoCurrency, int amount) {
    switch (cryptoCurrency) {
      case CryptoCurrency.xck:
        return _xcashKAmountToString(amount);
  ...
  static String _xcashKAmountToString(int amount) => _xcashKAmountFormat
      .format(cryptoAmountToDouble(amount: amount, divider: _xcashKAmountDivider));
  ...
  static String fromBaseUnits(String units, int decimals) {
    ...
    if (units.length <= decimals) {
      final s = units.padLeft(decimals + 1, '0');
