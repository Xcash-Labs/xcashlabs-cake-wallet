...
class CryptoCurrency extends EnumerableItem<int> with Serializable<int> implements Currency {
  ...
  static const xck = CryptoCurrency(title: 'XCK', fullName: 'XCash Klassic', raw: 0, name: 'xck', iconPath: 'assets/images/crypto/xcashklassic.webp', decimals: 6);
  static const xmr = xck;  // temporary alias during migration
