...
class TransactionListItem extends ActionListItem with Keyable {
  ...
  String get formattedCryptoAmount {
    ...
    if (balanceViewModel.wallet.type == WalletType.bitcoin) {
      ...
      return '${_appStore.amountParsingProxy.getDisplayCryptoString(transaction.amount, crypto).withLocalSeperator(_appStore.settingsStore.languageCode)} ${_appStore.amountParsingProxy.getCryptoSymbol(crypto)}';
    }
    return transaction.amountFormatted().withLocalSeperator(_appStore.settingsStore.languageCode);
  }
